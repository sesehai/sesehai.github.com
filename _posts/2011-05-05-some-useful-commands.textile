...
h3. wget请求播放地址：
wget -b -i url.txt 
http://113.57.248.61/smooth/getm3u8url.php?id=881735&mmsid=872687&vtype=1
取得地址：
wget -r [url]
...
p(date). 2010-11-22
h3. 拷贝数据：
scp * root@113.57.248.32:/lmk/site/mms.letv.com/
...
h3. 2.shell
  #!/bin/bash
  echo `date` >>/letv/data/phone/smst/stat.log
  cat /letv/data/phone/smst/mp4m800/mp4m800.log | grep found >> /letv/data/phone/smst/mp4m800/stat_csv.log
  tail  /letv/data/phone/smst/mp4m800/stat_csv.log
h3. 3.php cgi:
