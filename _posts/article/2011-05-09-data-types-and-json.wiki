...
前几天，我才知道有一种简化的数据交换格式，叫做[http://www.yaml.org/" yaml]。

我翻了一遍它的[http://www.yaml.org/spec/" 文档]，看懂的地方不多，但是有一句话令我茅塞顿开。
...
{{{ class="brush:php"
    ...
    即数据有一个名称，还有一个与之相对应的值，这又称作散列（hash）或字典（dictionary），
    比如"首都：北京"。
}}}
...
我马上想到了[http://www.json.org/json-zh.html" json]。
...
[http://www.ruanyifeng.com/blog/2009/05/data_types_and_json.html FROM] 
